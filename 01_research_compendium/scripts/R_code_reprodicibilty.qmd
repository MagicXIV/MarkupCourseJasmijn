...
# Package names
packages <- c("tidyverse", "haven", "dplyr", "tidyr", "lavaan", "lavaanPlot", "shiny", "ggplot2", "DiagrammeR")
...
SEMModelPlot <- last_plot()
ggsave(filename = "../results/SEMModel.tif", plot = SEMModelPlot, device = "tiff")
...
SEMModelPlotNL <- last_plot()
ggsave(filename = "../results/SEMModelNL.tif", plot = SEMModelPlotNL, device = "tiff")
...
SEMModelPlotDE <- last_plot()
ggsave(filename = "../results/SEMModelDE.tif", plot = SEMModelPlotDE, device = "tiff")
```
